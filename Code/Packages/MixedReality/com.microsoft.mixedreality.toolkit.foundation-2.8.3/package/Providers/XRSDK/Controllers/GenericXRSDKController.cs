...
namespace Microsoft.MixedReality.Toolkit.XRSDK.Input
{
    ...
    public class GenericXRSDKController : BaseController, IMixedRealityHapticFeedback
    {
        ...
        //true if this controller is a Logi MX Ink controller
        public bool? IsMXInk = null;
        ...
        public virtual void UpdateController(InputDevice inputDevice)
        {
            using (UpdateControllerPerfMarker.Auto())
            {
                ...
                {
                    //if this controller is a Logi MX Ink controller the trigger is mapped by the MXInkManager, skip the trigger press and trigger update
                    if(IsMXInk is true && (Interactions[i].InputType == DeviceInputType.TriggerPress || Interactions[i].InputType == DeviceInputType.Trigger))
                        continue;
