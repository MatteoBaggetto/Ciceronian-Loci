...
{
    public enum SeeItSayLabelDirectionEnum
    {
        Left,
        Right,
        Up,
    ...
    public partial class ButtonConfigHelper : MonoBehaviour
    {
        ...
        public TextMeshPro SeeItSayItLabelTMP => seeItSayItLabelText;
        public GameObject SeeItSayItLabel => seeItSayItLabel;

        private Transform seeItSayItLabelBackPanel;
        public Transform SeeItSayItLabelBackPanel => seeItSayItLabelBackPanel ??= SeeItSayItLabel.transform.GetChild(1).GetChild(0); //this is the quad object

        private RectTransform seeItSayItLabelRectTransform;
        public RectTransform SeeItSayItLabelRectTransform => seeItSayItLabelRectTransform ??= SeeItSayItLabelTMP.GetComponent<RectTransform>(); //this is the quad object
        ...
        [SerializeField]
        private SeeItSayLabelDirectionEnum seeItSayItLabelDirection = SeeItSayLabelDirectionEnum.Left;
        [SerializeField]
        private float seeItSayItLabelDirectionValue;
