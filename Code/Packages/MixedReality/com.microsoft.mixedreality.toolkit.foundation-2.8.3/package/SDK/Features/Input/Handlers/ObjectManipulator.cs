...
namespace Microsoft.MixedReality.Toolkit.UI
{
    ...
    public class ObjectManipulator : MonoBehaviour, IMixedRealityPointerHandler, IMixedRealityFocusChangedHandler, IMixedRealitySourcePoseHandler
    {
        ...
        public static bool IsManipulating => objectUnderManipulation != null;
        ...
        private static GameObject objectUnderManipulation = null;
        
        public static Action<GameObject> OnGlobalManipulationStarted, OnGlobalManipulationEnded;

        public static GameObject ObjectUnderManipulation
        {
            get => objectUnderManipulation;
            private set
            {
                if (objectUnderManipulation == null && value != null)
                    OnGlobalManipulationStarted?.Invoke(value);
                if (objectUnderManipulation != null && value == null)
                    OnGlobalManipulationEnded?.Invoke(objectUnderManipulation);
                objectUnderManipulation = value;
            }
        }
        ...
        private void HandleManipulationStarted()
        {
            ...
            ObjectUnderManipulation = this.gameObject;
